...
export default function PeopleList() {
    ...
    //constructor que se le pasa como parámetro de entrada una inyección
    //const viewModel = new PeopleListVM(container.get<IRepositoryPersonas>(TYPES.IRepositoryPersonas));
